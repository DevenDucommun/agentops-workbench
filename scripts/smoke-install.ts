...
runAndExpect(["agentops", "repo-report", "--session", "latest"], "AgentOps Repo Report");
runAndExpect(["agentops", "repo-report", "--session", "latest", "--format", "github"], "AgentOps Workbench Report");
